...
export const Component = () => {
  return (
    <Card size="small" orientation="horizontal">
      <CardPreview logo={<img class="sbdocs-img" src="word_logo.svg" alt="Microsoft Word logo" />}>
        <img class="sbdocs-img" src="doc_template.png" alt="Preview of a Word document " />
      </CardPreview>
    </Card>
  );
};
...
export const Default = () => {
  return (
    <Card orientation="horizontal">
      <div>
        <div>
          <img class="sbdocs-img" src="powerpoint_logo.svg" alt="Powerpoint logo" />
