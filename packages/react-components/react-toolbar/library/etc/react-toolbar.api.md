...
// @public
export const renderToolbar_unstable: (state: ToolbarState, contextValues: ToolbarContextValues) => JSX_2.Element;

// @public
export const renderToolbarGroup_unstable: (state: ToolbarGroupState) => JSX_2.Element;
