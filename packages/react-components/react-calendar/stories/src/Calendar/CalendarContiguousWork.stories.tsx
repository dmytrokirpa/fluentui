...
import { Calendar, DateRangeType, DayOfWeek } from '@fluentui/react-components';
...
CalendarContiguousWorkWeekDays.parameters = {
  docs: {
    description: {
      story: 'A Calendar can be modified to allow selecting a contiguous (5 day) work week.',
    },
  },
};
