...
import { Calendar, addDays } from '@fluentui/react-components';
import type { CalendarDayProps } from '@fluentui/react-components';
...
CalendarMarkedDays.parameters = {
  docs: {
    description: {
      story:
        'A Calendar allows you to pass a callback that returns an array of number that should be' +
