...
// @public
export const renderAlphaSlider_unstable: (state: AlphaSliderState) => JSX_2.Element;

// @public
export const renderColorArea_unstable: (state: ColorAreaState) => JSX_2.Element;

// @public
export const renderColorPicker_unstable: (state: ColorPickerState, contextValues: ColorPickerContextValues) => JSX_2.Element;

// @public
export const renderColorSlider_unstable: (state: ColorSliderState) => JSX_2.Element;
