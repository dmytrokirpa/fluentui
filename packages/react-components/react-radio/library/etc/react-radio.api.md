...
// @public
export const renderRadio_unstable: (state: RadioState) => JSX_2.Element;

// @public
export const renderRadioGroup_unstable: (state: RadioGroupState, contextValues: RadioGroupContextValues) => JSX_2.Element;
