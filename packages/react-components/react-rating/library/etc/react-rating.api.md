...
// @public
export const renderRating_unstable: (state: RatingState, contextValues: RatingContextValues) => JSX_2.Element;

// @public
export const renderRatingDisplay_unstable: (state: RatingDisplayState, contextValues: RatingDisplayContextValues) => JSX_2.Element;

// @public
export const renderRatingItem_unstable: (state: RatingItemState) => JSX_2.Element;
