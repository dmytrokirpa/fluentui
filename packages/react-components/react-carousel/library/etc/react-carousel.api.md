...
// @public
export const renderCarousel_unstable: (state: CarouselState, contextValues: CarouselContextValues) => JSX_2.Element;

// @public
export const renderCarouselAutoplayButton_unstable: (state: CarouselAutoplayButtonState) => JSX_2.Element;

// @public
export const renderCarouselButton_unstable: (state: CarouselButtonState) => JSX_2.Element;

// @public
export const renderCarouselCard_unstable: (state: CarouselCardState) => JSX_2.Element;

// @public
export const renderCarouselNav_unstable: (state: CarouselNavState, contextValues: CarouselNavContextValues) => JSX_2.Element;

// @public
export const renderCarouselNavButton_unstable: (state: CarouselNavButtonState) => JSX_2.Element;

// @public
export const renderCarouselNavContainer_unstable: (state: CarouselNavContainerState) => JSX_2.Element;

// @public
export const renderCarouselNavImageButton_unstable: (state: CarouselNavImageButtonState) => JSX_2.Element;

// @public
export const renderCarouselSlider_unstable: (state: CarouselSliderState, contextValues: CarouselSliderContextValues) => JSX_2.Element;

// @public
export const renderCarouselViewport_unstable: (state: CarouselViewportState, contextValues: CarouselSliderContextValues) => JSX_2.Element;
