    ...
    <>
      ...
      >
        <DrawerHeader className="border-b border-zinc-200 px-4 py-3">
          <DrawerHeaderNavigation aria-label="Drawer navigation" className="mb-2 text-xs uppercase text-zinc-500">
            Details
          </DrawerHeaderNavigation>
          <DrawerHeaderTitle
            action={
        ...
        <DrawerBody className="space-y-3 flex-grow overflow-auto px-4 py-3 text-sm text-zinc-700">
          <p className="m-0">Review the latest project details, update status, and keep related notes nearby.</p>
          <dl className="grid grid-cols-[max-content_1fr] gap-x-3 gap-y-2">
            <dt className="font-medium text-zinc-900">Owner</dt>
            <dd className="m-0">Design systems</dd>
            <dt className="font-medium text-zinc-900">Status</dt>
            <dd className="m-0">In progress</dd>
            <dt className="font-medium text-zinc-900">Due</dt>
            <dd className="m-0">Friday</dd>
          </dl>
        </DrawerBody>

        <DrawerFooter className="flex justify-end gap-2 border-t border-zinc-200 px-4 py-3">
          <button className={buttonClassName} onClick={() => setOpen(false)}>
            Cancel
          </button>
