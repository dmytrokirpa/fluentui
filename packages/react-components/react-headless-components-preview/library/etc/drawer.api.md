...
import type { DrawerBaseDefaultedProps } from '@fluentui/react-drawer';
import type { DrawerBaseProps } from '@fluentui/react-drawer';
...
// @public (undocumented)
export type InlineDrawerState = ComponentState<InlineDrawerSlots> & DrawerBaseDefaultedProps & Required<Pick<InlineDrawerProps, 'separator'>>;

// @public
export const OverlayDrawer: ForwardRefComponent<OverlayDrawerProps>;

// @public (undocumented)
export type OverlayDrawerProps = ComponentProps<OverlayDrawerSlots> & DrawerBaseProps & Pick<DialogProps, 'inertTrapFocus' | 'modalType' | 'onOpenChange'>;
...
// @public (undocumented)
export type OverlayDrawerState = ComponentState<OverlayDrawerSlots> & DrawerBaseDefaultedProps & Required<Pick<DialogProps, 'inertTrapFocus' | 'modalType'>> & Pick<DialogProps, 'onOpenChange'>;
