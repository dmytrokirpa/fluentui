...
// Re-exporting so there's no need to add @fluentui/react-calendar to dependencies just to localize.
export type { CalendarStrings } from '@fluentui/react-calendar';
