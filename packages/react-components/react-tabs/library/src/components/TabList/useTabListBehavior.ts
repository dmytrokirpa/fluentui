...
type TabListBehaviorState = Pick<
  ...
  | 'vertical'
> & {
  tabListProps: React.ComponentPropsWithRef<'div'>;
};
 ...
 */
export const useTabListBehavior_unstable = (
  props: TabListBehaviorProps,
  ref: React.Ref<HTMLElement>,
): TabListBehaviorState => {
  ...
  return {
    tabListProps: getIntrinsicElementProps('div', {
      // FIXME:
