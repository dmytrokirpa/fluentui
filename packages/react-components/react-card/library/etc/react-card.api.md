...
// @public
export const renderCard_unstable: (state: CardState, cardContextValue: CardContextValue) => JSX_2.Element;

// @public
export const renderCardFooter_unstable: (state: CardFooterState) => JSX_2.Element;

// @public
export const renderCardHeader_unstable: (state: CardHeaderState) => JSX_2.Element;

// @public
export const renderCardPreview_unstable: (state: CardPreviewState) => JSX_2.Element;
